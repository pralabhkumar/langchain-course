...
"""
    ...
    summary_template = """
Summarize the given information :::::: -----  {information} . Also provide two fun points from the given information. DO NOT SEARCH INTERNET. 
"""
    ...
    # print(summary_template_prompt.aformat_prompt)
    # llm = ChatOpenAI(model="gpt-5", temperature=0)
    llm = ChatOllama(model="mistral:latest", temperature=0)

    chain = summary_template_prompt | llm

    # Passing information to the chain.
